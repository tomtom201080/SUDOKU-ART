          ...
          <>
            ...
            {!userEmail && (
              <div className="challenge-step">
                <p className="challenge-step-title">{getLang() === 'fr' ? 'Ton prénom (optionnel)' : 'Your name (optional)'}</p>
                <input
                  type="text"
            ...
            <div className="challenge-step">
              <p className="challenge-step-title">{getLang() === 'fr' ? 'Ajouter une photo perso (optionnel)' : 'Add a personal photo (optional)'}</p>
              {photoPreview ? (
