export default {
  ...
  // ── Contenu SEO de l'accueil ─────────────────────────────────
  home_seo_free_title: 'Jouez gratuitement au Sudoku',
  home_seo_free_body: 'Sudoku Art est un jeu de Sudoku gratuit, accessible directement depuis votre navigateur, sans installation. Choisissez votre niveau parmi quatre difficultés — facile, moyen, compliqué ou enfer — et progressez à votre rythme, sur mobile comme sur ordinateur.',
  home_seo_reveal_title: 'Révélez une image cachée',
  home_seo_reveal_body: "Contrairement à un Sudoku classique, chaque grille de Sudoku Art cache une image derrière elle. Elle se dévoile progressivement à chaque chiffre correctement placé, jusqu'à apparaître entièrement une fois la grille terminée.",
  home_seo_image_title: "Une œuvre d'art, une photo ou un message",
  home_seo_image_body: "L'image révélée peut être une œuvre d'art tirée d'une galerie de tableaux célèbres, une photo personnelle que vous importez vous-même, ou même un message caché pour l'occasion. Vous pouvez aussi jouer en mode classique, sans aucune image.",
  home_seo_challenge_title: 'Créez un défi Sudoku personnalisé',
  home_seo_challenge_body: 'Une fois une grille terminée, envoyez-la en défi à un ami ou à tout un groupe via un simple lien. Chacun joue la même grille de son côté, et un classement compare les temps, les erreurs et les indices utilisés.',
  home_seo_friends_title: 'Défiez vos amis et vos proches',
  home_seo_friends_body: 'Que ce soit un duel à deux ou un défi de groupe entre amis, en famille ou entre collègues, Sudoku Art transforme une grille en moment à partager, avec ou sans création de compte pour les participants.',
  home_seo_devices_title: 'Sur mobile et sur ordinateur',
  home_seo_devices_body: 'Le jeu s\'adapte à tous les écrans, sans rien installer : commencez une grille sur votre téléphone et continuez sur ordinateur si vous préférez.',
  home_seo_howto_title: 'Comment fonctionne Sudoku Art ?',
  home_seo_howto_body: 'Le principe reste celui du Sudoku classique : remplir chaque ligne, chaque colonne et chaque bloc de 3×3 avec les chiffres de 1 à 9, sans répétition.',
  home_seo_howto_link: 'Découvrez le fonctionnement complet du jeu et de ses défis',
  home_seo_art_link: 'Voir les œuvres à découvrir',
  home_seo_challenge_link: 'En savoir plus sur les défis',
