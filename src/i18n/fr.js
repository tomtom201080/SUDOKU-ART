export default {
  ...
  _en: 'en',
  _: '🇬🇧',
  _galit_parfaite: 'Égalité parfaite !',
  _tu_as_gagn: 'Tu as gagné 🏆',
  _donn_es_collect_es: 'Données collectées',
  _utilisation_des_donn_es: 'Utilisation des données',
  _publicit: 'Publicité',
  _vos_droits: 'Vos droits',
  _automatique_au_hasard: 'Automatique (au hasard)',
  _lien_copi: '✅ Lien copié !',
  _1_choose_the_photo_to_reveal: '1. Choose the photo to reveal',
  _2_niveau_de_difficult: '2. Niveau de difficulté',
  _4_temps_respecter: '4. Temps à respecter',
  _en_vigueur_depuis_le_1er_juill: 'En vigueur depuis le 1er juillet 2025',
  _1_pr_sentation_du_service: '1. Présentation du service',
  _sudoku_art_est_une_application: 'Sudoku Art est une application web progressive (PWA) gratuite permettant de jouer au sudoku en dévoilant une image.',
  _2_acc_s_au_service: '2. Accès au service',
  _3_contenu_utilisateur_et_phot: '3. Contenu utilisateur et photos personnelles',
  _vous_pouvez_uploader_des_photo: 'Vous pouvez uploader des photos personnelles pour les utiliser comme fond de grille.',
  _que_la_photo_ne_contient_pas_d: 'Que la photo ne contient pas de contenu illégal ou offensant',
  _avoir_obtenu_le_consentement_d: 'Avoir obtenu le consentement des personnes photographiées.',
  _les_photos_de_d_fis_sont_autom: 'Les photos de défis sont automatiquement supprimées après 7 jours.',
  _4_propri_t_intellectuelle: '4. Propriété intellectuelle',
  _5_responsabilit: '5. Responsabilité',
  _6_modification_des_cgu: '6. Modification des CGU',
  _ces_cgu_peuvent_tre_modifi_es: 'Ces CGU peuvent être modifiées à tout moment.',
  _7_droit_applicable: '7. Droit applicable',
  _ces_cgu_sont_soumises_au_droit: 'Ces CGU sont soumises au droit français.',
  _conforme_rgpd_mise_jour_le: 'Conforme RGPD — mise à jour le 1er juillet 2025',
  _responsable_du_traitement: 'Responsable du traitement',
  _donn_es_collect_es_et_finalit: 'Données collectées et finalités',
  _donn_e: 'Donnée',
  _finalit: 'Finalité',
  _dur_e: 'Durée',
  _authentification_envoi_de_d_f: 'Authentification, envoi de défis',
  _fond_de_grille_dans_les_d_fis: 'Fond de grille dans les défis',
  _sauvegarde_multi_appareils_ga: 'Sauvegarde multi-appareils, galerie',
  _am_lioration_du_service: 'Amélioration du service',
  _m_moriser_votre_choix_publicit: 'Mémoriser votre choix publicitaire',
  _publicit_et_cookies_tiers: 'Publicité et cookies tiers',
  _vos_droits_rgpd: 'Vos droits (RGPD)',
  _sous_traitants: 'Sous-traitants',
  _supabase_bdd_usa_eu_verce: 'Supabase (BDD, USA/EU) · Vercel (hébergement, USA) · Google (AdSense si accepté)',
  _changer_mon_choix_publicitaire: 'Changer mon choix publicitaire :',
  _refuser_la_pub_personnalis_e: 'Refuser la pub personnalisée',
  _fermer: 'Fermer',
  _tu_as_gagn_ce_d_fi: '🏆 Tu as gagné ce défi !',
  _installer_sudoku_art: '📲 Installer Sudoku Art',
  _compris: 'Compris !',
  _tape_verrouill_e: 'Étape verrouillée',
  _image_d_bloqu_e: 'Image débloquée',
  _compte_cr_v_rifie_ta_bo_te: 'Compte créé ! Vérifie ta boîte mail pour confirmer ton adresse.',
  _email_envoy_clique_sur_le_l: 'Email envoyé ! Clique sur le lien pour choisir un nouveau mot de passe.',
  _mot_de_passe_oubli: 'Mot de passe oublié',
  _chargement_de_ta_qu_te: 'Chargement de ta quête…',
  _qu_te_sudomath: '🧠 Quête Sudomath',
  _photo_cach_e: '📷 Photo cachée',
  _classement: '🏆 Classement',
  _ton_pr_nom_optionnel: 'Ton prénom (optionnel)',
  _ajouter_une_photo_perso_optio: 'Ajouter une photo perso (optionnel)',
  _aucune_erreur: 'aucune erreur 🏆',
  _tu_as_gagn_cette_fois: 'Tu as gagné cette fois 😅',
  _photo_personnelle_d_voil_e: 'Photo personnelle dévoilée',
  _tableau_d_bloqu: 'Tableau débloqué',
  _qu_te_sudokart: '🏆 Quête Sudokart',
  _2_difficult: '2. Difficulté',
  _4_photo_optionnel: '4. Photo (optionnel)',
  _5_ton_pr_nom: '5. Ton prénom',
  _statistiques: '📊 Statistiques',
  _7_derniers_jours: '7 derniers jours',
  _les_deux_mots_de_passe_ne_corr: 'Les deux mots de passe ne correspondent pas.',
  _mot_de_passe_mis_jour: 'Mot de passe mis à jour !',
  _mettre_jour_le_mot_de_passe: 'Mettre à jour le mot de passe',
