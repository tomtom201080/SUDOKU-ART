export default {
  ...
  // ── Home SEO content ────────────────────────────────────────────
  home_seo_free_title: 'Play Sudoku for free',
  home_seo_free_body: 'Sudoku Art is a free Sudoku game, playable straight from your browser with nothing to install. Pick your level from four difficulties — easy, medium, hard or hell — and play at your own pace, on mobile or desktop.',
  home_seo_reveal_title: 'Reveal a hidden picture',
  home_seo_reveal_body: 'Unlike a classic Sudoku, every grid on Sudoku Art hides a picture behind it. It uncovers gradually with every correctly placed number, until it appears in full once the grid is complete.',
  home_seo_image_title: 'An artwork, a personal photo, or a message',
  home_seo_image_body: 'The revealed picture can be an artwork from a gallery of famous paintings, a personal photo you upload yourself, or even a hidden message for the occasion. You can also play in classic mode, with no image at all.',
  home_seo_challenge_title: 'Create a custom Sudoku challenge',
  home_seo_challenge_body: 'Once you finish a grid, send it as a challenge to a friend or an entire group with a simple link. Everyone plays the same grid on their own, and a leaderboard compares completion time, errors and hints used.',
  home_seo_friends_title: 'Challenge your friends and family',
  home_seo_friends_body: 'Whether it\'s a one-on-one duel or a group challenge with friends, family or coworkers, Sudoku Art turns a grid into something to share, with or without an account for participants.',
  home_seo_devices_title: 'On mobile and desktop',
  home_seo_devices_body: 'The game adapts to any screen, nothing to install: start a grid on your phone and continue on desktop if you prefer.',
  home_seo_howto_title: 'How does Sudoku Art work?',
  home_seo_howto_body: 'The core rules stay the same as a classic Sudoku: fill every row, column and 3×3 block with the digits 1 to 9, with no repeats.',
  home_seo_howto_link: 'See the full explanation of the game and its challenges',
  home_seo_art_link: 'See the artworks to discover',
  home_seo_challenge_link: 'Learn more about challenges',
